...
const useStyles = makeStyles((theme) => ({
  ...
  inputMensagemAvaliacao: {
    [theme.breakpoints.down("xs")]: {
      paddingTop: "10px",
    },
  },
  inputLabelMensagemAvaliacao: {
    [theme.breakpoints.down("xs")]: {
      fontSize: "14px",
    ...
    try {
      if (whatsAppId) {
        if (
          ...
          toast.warning(i18n.t("userModal.warning.updateImage"), {
            autoClose: false,
          });
          try {
              ...
              <Paper className={classes.paper} elevation={0}>
                ...
                >
                  <DialogContent dividers>
                    ...
                    {/* NOME E PADRAO */}
                    <div className={classes.containerInputName}>
                      ...
                      <div className={classes.tratarGrupo}>
                        <FormControl
                          variant="outlined"
                          margin="dense"
                          fullWidth
                    ...
                    <div style={{ marginTop: 2 }}>
                      ...
                      <div className={classes.containerRedirecionamento}>
                        <div style={{ flex: 1 }}>
                          <FormControl
                            variant="outlined"
                            margin="dense"
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            ...
                            <Field
                              ...
                              placeholder={i18n.t(
                                "whatsappModal.form.timeSendQueue"
                              )}
                            ...
                            >
                              ...
                              <MenuItem value={"5"}>
                                5 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                              <MenuItem value={"10"}>
                                10 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                              <MenuItem value={"15"}>
                                15 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                              <MenuItem value={"15"}>
                                20 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                              <MenuItem value={"15"}>
                                25 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                              <MenuItem value={"30"}>
                                30 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                              <MenuItem value={"60"}>
                                60 {i18n.t("whatsappModal.menuItem.minutes")}
                              </MenuItem>
                            </Field>
                          </FormControl>
                        </div>
                  ...
                  <DialogContent dividers>
                    ...
                    <div>
                      <Field
                        ...
                        fullWidth
                        InputProps={{
                          classes: { input: classes.inputMensagemAvaliacao },
                        }}
                  ...
                  <DialogContent dividers>
                    ...
                    <div>
                      <Field
                        ...
                        fullWidth
                        InputLabelProps={{
                          className: classes.inputLabelMensagemAvaliacao,
                        }}
                        InputProps={{
                          classes: { input: classes.inputMensagemAvaliacao },
                        }}
