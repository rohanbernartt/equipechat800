      ...
      settings: {
        ...
        settings: {
          ...
          options: {
            ...
            companyManagement: "Management by Company",
            connectionManagement: "Connection Management",
            sendGreetingAccepted: "Send greeting when accepting ticket",
            sendMsgTransfTicket: "Send sector/attendant transfer message",
            checkMsgIsGroup: "Ignore Group Posts",
            chatBotType: "Bot Type",
            userRandom: "Choose random attendant",
            buttons: "Buttons",
            acceptCallWhatsapp:
              "Inform that you do not accept calls on WhatsApp?",
            sendSignMessage: "Allows attendant to choose SEND Signature",
            sendGreetingMessageOneQueues:
              "Send greeting when there is only 1 queue",
            sendQueuePosition: "Send message with queue position",
            sendFarewellWaitingTicket: "Send a farewell message in Waiting",
            acceptAudioMessageContact:
              "Do you accept receiving audio from all contacts?",
            enableLGPD: "Enable LGPD processing",
            requiredTag: "Mandatory tag to close ticket",
            transferMessage: "Queue transfer message",
            greetingMessageTicket: "Greeting message when accepting the ticket",
            refuseTelephoneCallMessage:
              "Message to inform you that you do not accept telephone calls",
            queuePositionMessage: "Queue position message",
          },
        },
      },
      messagesList: {
