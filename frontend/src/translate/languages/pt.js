    ...
    translations: {
      ...
      contacts: {
        ...
        confirmationModal: {
          ...
          deleteAllContact: "Tem certeza que deseja deletar todos os contatos? Todos os atendimentos relacionados serão perdidos.",
        ...
        menu: {
          ...
          importOrExport: "Importar / Exportar"
        },
      },
      forwardMessage: {
        text: "Encaminhada",
      ...
      settings: {
        ...
        settings: {
          ...
          options: {
            ...
            transferMessage: "Mensagem de transferência da fila",
            greetingMessageTicket: "Mensagem de saudação ao aceitar o ticket",
            refuseTelephoneCallMessage: "Mensagem para informar quer não aceita ligações",
            queuePositionMessage: "Mensagem de posição na fila"
          },
          LGPD: {
            title: "LGPD",
